...
public class StatusTest {
    ...
    public static void main(String[] args) throws XMLStreamException, Exception {
        ...
        InputStream resourceAsStream = StatusTest.class.getResourceAsStream("/nfeServidoresHom.ini");
        Ini ini = new Ini(resourceAsStream);
        System.out.println(ini.get("PB", "NfeStatusServico4"));
        /*URL url = new URL("https://nfe.svrs.rs.gov.br/ws/NfeStatusServico/NfeStatusServico4.asmx");
        ...
        String xml = marshal(status).replace(" standalone=\"yes\"", "");
        System.out.println(xml);
        OMElement ome = AXIOMUtil.stringToOM(xml);
        NFeStatusServico4Stub.NfeDadosMsg dadosMsg = new NFeStatusServico4Stub.NfeDadosMsg();
        dadosMsg.setExtraElement(ome);
        NFeStatusServico4Stub stub = new NFeStatusServico4Stub(url.toString());
        ...
        System.out.println("Motivo: " + response.getXMotivo());*/
//        double x = 0;
//        while(x == 0){
//            double parseDouble = Double.parseDouble(JOptionPane.showInputDialog("Digita o valor: ").replace(",", "."));
//            if(parseDouble == 0){
//                x = 1;
//            }
//            double dif = parseDouble - (parseDouble * 0.6 / 100);
